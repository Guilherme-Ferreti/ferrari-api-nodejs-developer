    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.createTable(
            new Table({
                ...
                columns: [columnId, columnVarchar('name', '45'), columnCreatedAt, columnUpdatedAt],
            }),
        );

        const payment_situations = ['Aguardando Pagamento', 'Cancelado', 'Pagamento Aprovado', 'Pagamento Estornado', 'Em mediação', 'Enviado'];
